...
typesafe.akka=file:${karaf.home}system/com/typesafe/akka/2.3.15/net.echinopsii.3rdparty.akka-features-2.3.15.xml
infinispan=file:${karaf.home}system/org/infinispan/6.0.2/net.echinopsii.3rdparty.infinispan-features-6.0.2.xml
ariane.community.messaging=file:${karaf.home}system/net/echinopsii/ariane/community/messaging/0.2.2-SNAPSHOT/net.echinopsii.ariane.community.messaging-features-0.2.2-SNAPSHOT.xml
ariane.community.core.mapping-back=file:${karaf.home}system/net/echinopsii/ariane/community/core/mapping/0.8.2-MS-SNAPSHOT/net.echinopsii.ariane.community.core.mapping-features-0.8.2-MS-SNAPSHOT.xml

...
featuresRepositories = \
    ...
    file:${karaf.home}system/net/echinopsii/ariane/community/messaging/0.2.1-SNAPSHOT/net.echinopsii.ariane.community.messaging-features-0.2.1-SNAPSHOT.xml, \
    file:${karaf.home}system/net/echinopsii/ariane/community/core/mapping/0.8.1-MS-SNAPSHOT/net.echinopsii.ariane.community.core.mapping-features-0.8.1-MS-SNAPSHOT.xml

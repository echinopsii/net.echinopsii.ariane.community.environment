...
featuresRepositories = \
    ...
    file:${karaf.home}system/net/echinopsii/ariane/community/messaging/0.2.2-SNAPSHOT/net.echinopsii.ariane.community.messaging-features-0.2.2-SNAPSHOT.xml, \
    file:${karaf.home}system/net/echinopsii/ariane/community/core/mapping/0.8.2-MS-SNAPSHOT/net.echinopsii.ariane.community.core.mapping-features-0.8.2-MS-SNAPSHOT.xml

...
[uninstalled] [4.0.3 ] wrapper           standard-4.0.3      Provide OS integration
[uninstalled] [4.0.3 ] obr               standard-4.0.3      Provide OSGi Bundle Repository (OBR) support
[uninstalled] [4.0.3 ] config            standard-4.0.3      Provide OSGi ConfigAdmin support
[uninstalled] [4.0.3 ] region            standard-4.0.3      Provide Region commands
[uninstalled] [7.5.4.v20111024] jetty             standard-4.0.3      Provide Jetty engine support
[uninstalled] [4.0.3 ] http              standard-4.0.3      Implementation of the OSGI HTTP Service
[uninstalled] [4.0.3 ] http-whiteboard   standard-4.0.3      Provide HTTP Whiteboard pattern support
[uninstalled] [4.0.3 ] war               standard-4.0.3      Turn Karaf as a full WebContainer
[uninstalled] [4.0.3 ] deployers         standard-4.0.3      Provide Karaf deployer
[uninstalled] [4.0.3 ] kar               standard-4.0.3      Provide KAR (KARaf archive) support
[uninstalled] [4.0.3 ] webconsole-base   standard-4.0.3      Base support of the Karaf WebConsole
[uninstalled] [4.0.3 ] webconsole        standard-4.0.3      Karaf WebConsole for administration and monitoring
[uninstalled] [4.0.3 ] ssh               standard-4.0.3      Provide a SSHd server on Karaf
...
Maven builds the web application, web-4.0.3.war, and
